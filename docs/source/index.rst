...
It can be download from `Link PyPi <https://pypi.org/project/TMotorCANControl/>`_ with
the command "pip install TMotorCANControl".

The API files are on `Link GitHub <https://github.com/neurobionics/TMotorCANControl>`_, 
